                                          ...
                                          @if($lastStudents)
                                            @foreach($lastStudents as $lastStudent)
                                              <tr>
                                                  ...
                                                  <td><button class="btn btn-xs btn-info" data-toggle="modal" data-target="{{'#single-view'.$lastStudent->id}}"><i class="fa fa-eye"></i></button> | <a class="btn btn-xs btn-info" href="{{URL::to('student/'.$lastStudent->id.'/edit')}}"><i class="fa fa-edit"></i></a> | 
